...
if ($page > 1) {
	$html = file_get_contents("http://www.emaramures.ro/Video-Maramures/Default.aspx?Page=".$page);
} else {
	$page = 1;
	$html = file_get_contents("http://www.emaramures.ro/Video-Maramures/Default.aspx");
}
if($page > 1) { ?>
...
$videos = explode('div class="VideoThumbContainer">', $html);
...
foreach($videos as $video) {
  ...
  $link = substr($image, 0, -8).".flv";
  $link=str_replace("Thumbs","FLV",$link);
  if (strpos($link,"Users/Vasile") === false) {
