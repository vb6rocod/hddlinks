...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/tv/locale/telem_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
$image="/usr/local/etc/www/cgi-bin/scripts/tv/image/telem.png";
foreach($videos as $video) {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/locale/telem_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
