...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/tv/locale/tvt89_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
foreach($videos as $video) {
    	...
    	$descriere = str_between($video,'<td class="titlu_emisiune">','</td>');
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/locale/tvt89_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
