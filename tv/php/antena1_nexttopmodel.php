...
<channel>
	...
	<menu>main menu</menu>
<?php
//http://nexttopmodel.a1.ro/paginare/2
$link="http://nexttopmodel.a1.ro/emisiuni.php";
...
$html=str_between($html,'<div id="video-arhiva-list">','<div class="clearfix">');
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "http://nexttopmodel.a1.ro".$t2[0];
