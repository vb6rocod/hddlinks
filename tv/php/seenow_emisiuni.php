...
$html = file_get_contents("http://www.seenow.ro/emisiuni-tv-2697-pagina-1");
...
foreach($videos as $video) {
  ...
  $title=$t3[0];
		...
		if (!preg_match("/Realitatea|B1/i",$title)) {
			$link = $host."/scripts/tv/php/seenow_e.php?query=1,".$link.",".urlencode($title);
    	echo '
    	<item>
    		<title>'.$title.'</title>
    		<link>'.$link.'</link>
