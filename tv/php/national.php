...
//http://www.nationaltv.ro/emisiuni/sa-vamintiti-duminica
$link = $_GET["query"];
...
//http://www.nationaltv.ro/_ajax_load_youtube.php
//http://www.nationaltv.ro/emisiuni/sa-vamintiti-duminica#v-68
$videos = explode('class="load-youtube', $html);
...
foreach($videos as $video) {
    ...
    $image="/usr/local/etc/www/cgi-bin/scripts/tv/image/national.jpg";
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/php/national_link.php?file='.urlencode($l).'";
    movie=getUrl(url);
    titlu=movie;
    cancelIdle();
