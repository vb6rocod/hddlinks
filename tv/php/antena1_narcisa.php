...
<channel>
	...
	<menu>main menu</menu>
<?php
//http://iubirinelegiuite.a1.ro/videos/lister/page:1/type:episoade
$query = $_GET["query"];
if($query) {
...
if($page) {
		$html = file_get_contents("http://iubirinelegiuite.a1.ro/videos/lister/page".$page."/type:episoade");
} else {
    $page = 1;
    $html = file_get_contents("http://iubirinelegiuite.a1.ro/videos/lister/page".$page."/type:episoade");
}
...
$html=str_between($html,'<div class="clearfix widelist">','<div class="paginator">');
...
foreach($videos as $video) {
    $t1=explode('"',$video);
    $link="http://iubirinelegiuite.a1.ro".$t1[0];
    $t1 = explode('src="', $video);
    $t2 = explode('"', $t1[1]);
    $image = $t2[0];
    //http://ivm.inin.ro/thumbs/antena1/2011/03/27/U0Zk6yyM96V_3T.jpg
    //http://vodh1.inin.ro/antena1/2011/03/27/U0Zk6yyM96V.mp4
    //http://vodh3.inin.ro/antena1/2011/11/03/HJWltQdlaaK.mp4?start=0
    //$t1=explode("_",$image);
    //$link=$t1[0];
    //$link=str_replace("http://ivm.inin.ro/thumbs/","http://vodh1.inin.ro/",$link).".mp4";
    $link="http://127.0.0.1/cgi-bin/scripts/tv/php/antena1_link.php?file=".urlencode($link);
    $title=str_between($video,'<span class="title">','</span>');
