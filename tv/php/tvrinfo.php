...
<channel>
	<title>TVR Info - Top video</title>
	<menu>main menu</menu>


<?php
$html = file_get_contents("http://www.tvrinfo.ro/top-video.html");
...
$videos = explode('div class="videoContainer"', $html);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $title = trim(str_between($video,'div class="title">','<'));
    $link = str_between($video,'filename" value="','"');
