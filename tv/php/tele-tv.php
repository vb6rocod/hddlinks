...
if (userInput == "pagedown" || userInput == "pageup")
{
  ...
  ret="true";
	...
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/tv/php/tele-tv_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
...
<?php
//http://www.tele-tv.info/pagini-seriale/2
//http://www.tele-tv.info/pagini-emisiuni/2
//http://www.tele-tv.info/pagini_e/emisiuni/1
...
foreach($videos as $video) {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/php/tele-tv_link.php?file='.urlencode($link).'";
    movie=getUrl(url);
    cancelIdle();
