...
//http://webtv.money.ro/videos/index/lpage/1#videos_listing
if($page) {
  $html = file_get_contents("http://webtv.money.ro/videos/index/lpage/".$page."#videos_listing");
} else {
  $page = 1;
  $html = file_get_contents("http://webtv.money.ro/videos/index/lpage/".$page."#videos_listing");
}
...
//<div id="ve_listing_videos">
//<div class="pagination">
$html=str_between($html,'div id="ve_listing_videos"','div class="pagination"');
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $title = $t2[0];
    //http://vcache.money.ro/1/2011-10/a911b13b2c4b0d8bb702856ac98287c1_medium.jpg
    $link = substr($image, 0, -11).".flv";
