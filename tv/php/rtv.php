...
if (userInput == "pagedown" || userInput == "pageup")
{
  ...
  ret="true";
	...
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/tv/php/rtv_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
...
<?php
$link="http://livenews.rtv.net/videos.php?category=".$search."&page=".$page;
//echo $link;
...
foreach($videos as $video) {
    ...
    $t1 = explode('playlist_item_text">', $video);
    $t2 = explode('>', $t1[1]);
    $t3=explode("<",$t2[1]);
    $title = $t3[0];
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/php/rtv_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
