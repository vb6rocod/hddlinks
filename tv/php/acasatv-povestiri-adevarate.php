...
//http://www.acasatv.ro/povestiri-adevarate/pagina/2
//$html = file_get_contents("http://www.acasatv.ro/stiri-despre/povestiri-adevarate-1/pagina".$page.".html");
$html=file_get_contents("http://www.acasatv.ro/povestiri-adevarate/pagina/".$page);
if($page > 1) { ?>
...
$videos = explode('div class="bottomOrangeDot"', $html);
