...
<channel>
	...
	<menu>main menu</menu>
<?php
//http://xfactor.a1.ro/video/episoade
...
$html = file_get_contents("http://xfactor.a1.ro/video/episoade");
$html=str_between($html,'<div class="box images">','<div class="box-footer">');
