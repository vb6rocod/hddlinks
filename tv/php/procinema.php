...
$html = file_get_contents("http://procinema.ro/video/clipuri/pagina-".$page);
...
$videos = explode('div class="vItem"', $html);
...
foreach($videos as $video) {
    ...
    $t3=explode("_",$image);
    $file=$t3[1];
    $t4=explode("thumb",$image);
    $file=str_replace("jpg","flv",$file);
    $link=$t4[0].$file;
    */
    $link=str_replace("jpg","flv",$image);
    for ($i=1;$i<7;$i++) {
     $rep="thumb".$i."_";
     $link=str_replace($rep,"",$link);
    }
    //http://assets.sport.ro/assets/procinema/2011/03/30/videos/12238/thumb6_ctp.jpg
    //http://assets.sport.ro/assets/procinema/2011/03/30/videos/12238/ctp.flv?start=0
