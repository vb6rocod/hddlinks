...
<channel>
	<title>Kanald.ro - Emisiuni</title>
	<menu>main menu</menu>
...
//$page = $_GET["query"];
//http://www.kanald.ro/Multimedia/Stiri/pagina/2/
$link="http://www.kanald.ro/emisiuni.html";
...
foreach($videos as $video) {
 ...
 $title=$t2[0];
 if (!$title) $title=$desc;
 $link=$host."/scripts/tv/php/kanald.php?file=".urlencode($title).",".$link;
 
 if (strpos($link,"emisiuni") !==false) {
    echo '
    <item>
    <title>'.$title.'</title>
    <link>'.$link.'</link>
