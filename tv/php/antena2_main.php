...
$html = file_get_contents("http://www.antena2.ro/emisiuni");
$image = "/usr/local/etc/www/cgi-bin/scripts/tv/image/antena2.jpg";
...
foreach($videos as $video) {
  ...
  $t2=explode("<",$t1[1]);
  $data=c($t2[0])."...";
  $link = $host."/scripts/tv/php/antena2.php?query=1,".$link.",".urlencode($title);
