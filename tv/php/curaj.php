...
>
    ...
    Daca nu merge din prima mai incecati o data!
		</text>
...
//http://curaj.tv/page/2/
$l="http://curaj.tv/page/".$page."/";
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $l);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.2) Gecko/20090729 Firefox/3.5.2 GTB5');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION  ,1);
  curl_setopt($ch,CURLOPT_REFERER,"http://curaj.tv");
...
foreach($videos as $video) {
  ...
  $t2=explode('"',$t1[1]);
  $image=$t2[0];
  //http://i1.ytimg.com/vi/uZAkbEeS2q0/0.jpg
  if(preg_match('/ytimg\.com\/(vi\/|watch\?v=)([\w\-]+)/', $image, $match)) {;
  $id = $match[2];
  $link="http://www.youtube.com/watch?v=".$id;
  $link="http://127.0.0.1/cgi-bin/scripts/filme/php/link.php?file=".urlencode($link);
  $link="http://127.0.0.1/cgi-bin/scripts/util/yt.php?file=".urlencode($link);
