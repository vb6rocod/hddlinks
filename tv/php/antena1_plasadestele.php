...
<channel>
	...
	<menu>main menu</menu>
<?php
//http://plasadestele.a1.ro/paginare/stele/2/all
$query = $_GET["query"];
if($query) {
...
if($page) {
		$html = file_get_contents("http://plasadestele.a1.ro/paginare/stele/".$page."/all");
} else {
    $page = 1;
    $html = file_get_contents("http://plasadestele.a1.ro/paginare/stele/".$page."/all");
}
...
foreach($videos as $video) {
    ...
    $name = preg_replace('/[^A-Za-z0-9_]/','_',"Plasa de stele - ".$title).".mp4";
