  	...
  	<text  redraw="yes" align="center" offsetXPC="60" offsetYPC="52" widthPC="30" heightPC="5" fontSize="17" backgroundColor="10:105:150" foregroundColor="100:200:255">
		...
		<text align="center" redraw="yes"
          lines="10" fontSize=17
		      offsetXPC=55 offsetYPC=60 widthPC=40 heightPC=30
...
//http://antena2.ro/arhiva/agentul-vip/page-2
if($page > 1) { ?>
...
$videos = explode('<div class="item left', $html);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    //$link = "http://www.antena2.ro".$t2[0];
    $link=$t2[0];
    $t1 = explode(' src="', $video);
    $t2 = explode('"', $t1[1]);
    $image = $t2[0];
    
    $t1=explode('<span class="left">',$video);
...
//http://vodh1.inin.ro/antena2/2011/04/06/3nj6p7wRrsQ.mp4?start=0
//http://ivm.inin.ro/thumbs/antena2/2011/04/06/3nj6p7wRrsQ_1T.jpg
if ($pos === false) {
 $image = "http://www.antena2.tv".$image;
}
    $link="http://127.0.0.1/cgi-bin/scripts/tv/php/antena1_link.php?file=".urlencode($link);
    $name = preg_replace('/[^A-Za-z0-9_]/','_',$tit." - ".$title).".mp4";
	echo'
	<item>
	<title>'.$title.'</title>
    <onClick>
