...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/tv/sport/cfr_cluj_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
foreach($items as $item) {
    ...
    $link = "http://www.cfr1907.ro".$link;

    //http://www.cfr1907.ro/images/video/g273/thumbs/braga.jpg
    ///images/video/g274/thumbs/
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/sport/cfr_cluj_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
