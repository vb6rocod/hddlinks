...
$html = file_get_contents("http://euro-2012.ro/video/page/".$page);
...
$videos = explode('class="teammenu left', $html);
...
foreach($videos as $video) {
    ...
    $annotation=str_between($video,"</h2>","</div");
