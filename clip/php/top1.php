...
if (userInput == "pagedown" || userInput == "pageup")
{
  ...
  ret="true";
	...
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/clip/php/top1_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
...
$html=str_between($html,'div id="panou_thumbs','<div');
$videos = explode('src="', $html);
unset($videos[0]);
...
foreach($videos as $video) {
    ...
    $title = str_between($video,'class="p">','<');
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/clip/php/top1_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
