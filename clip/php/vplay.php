...
>
    ...
    Apăsaţi 2 pentru download, 3 pentru Download Manager
  	...
  	<text redraw="yes" offsetXPC="85" offsetYPC="12" widthPC="10" heightPC="6" fontSize="20" backgroundColor="10:105:150" foregroundColor="60:160:205">
		...
		<text align="center" redraw="yes" fontSize=17
		      offsetXPC=55 offsetYPC=55 widthPC=40 heightPC=8
...
$videos = explode('class="article"', $html);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = $t2[0];
    $link = $host."/scripts/clip/php/vplay_link.php?file=".$link;

    $t1 = explode('src="', $video);
    $t2 = explode('"', $t1[1]);
    $image = $t2[0];

    $title=str_between($video,'"article-title">','<');

    $data = trim(str_between($video,'<b>',"</b>"));
