...
if (userInput == "two" || userInput == "2")
	{
     ...
     cancelIdle();
	 topUrl = "http://127.0.0.1/cgi-bin/scripts/util/download.cgi?link=" + url + ";name=" + getItemInfo(getFocusItemIndex(),"name");
...
<?php
//http://video.rol.ro/categorii/Videoclipuri.htm
//http://video.rol.ro/categorii/Videoclipuri-Cele-mai-noi/pagina-2.htm
$link=str_replace(".htm","-Cele-mai-noi/pagina-",$search);
$link = $link.$page.".htm";
...
$html1=str_between($html,'class="video_items"','<div class="paginatie">');
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $image = $t2[0];
    //http://i1.videomix.ro/thumb/67790/2_55779.jpg
    //http://i1.videomix.ro/flvs/67790/55779.flv
    //http://f1.videomix.ro/flvs/67790/55779.flv?start=0
    $link=str_replace("thumb","flvs",$image);
    $link=str_replace("http://i","http://f",$link);
    $link=str_replace("jpg","flv",$link);
    $part2=substr(strrchr($link,"/"),1);
    $t1=explode("_",$part2);
    $part2_r=$t1[1];
    $link=str_replace($part2,$part2_r,$link);
    $t1 = explode('title="', $video);
    $t2 = explode('"', $t1[1]);
    $title = $t2[0];


    $t1=explode('span class="time2">',$video);
    $t2=explode('<',$t1[1]);
    $durata = "Durata:".$t2[0];
