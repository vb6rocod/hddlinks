...
<channel>
	<title>Vimeo - Categorii</title>
	<menu>main menu</menu>
		<item>
			<title>Cautare după tag video</title>
		...
		<item>
			<title>Afişare video user... (indice numeric, ex. 4936621)</title>
		...
		<item>
			<title>Afişare canal... (nume exact)</title>
		...
		<item>
			<title>Afişare grup... (nume exact)</title>
