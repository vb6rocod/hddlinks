...
if($page) {
    if($search) {
        $html = file_get_contents("http://www.dump.ro/videoclipuri/pag".$page);
    } else {
        $html = file_get_contents("http://www.dump.ro/videoclipuri/pag".$page);
    }
} else {
    $page = 1;
    if($search) {
        $html = file_get_contents("http://www.dump.ro/videoclipuri");
    } else {
        $html = file_get_contents("http://www.dump.ro/videoclipuri");
    }
}
...
$html = str_between($html,'<ul class="list">','</ul>');
