...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/clip/php/video_alege_net_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
$page1 = 16*$page;
$html = file_get_contents($search.$page1.".html");
...
$html=str_between($html,'<ul class="matrix clearfix">','</ul>');
...
if ($link <> "") {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/clip/php/video_alege_net_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
