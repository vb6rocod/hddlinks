...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/clip/php/almanahe_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
$videos = explode('<div id="videolist_thumb', $html);
...
foreach($videos as $video) {
    ...
    $t1=explode('<span class="clsRunTime">',$video);
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/clip/php/almanahe_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
