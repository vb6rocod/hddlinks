...
<channel>
	<title>www.990.ro - desene animate</title>
	<menu>main menu</menu>


<?php
$html = file_get_contents("http://www.990.ro/desene-animate.html");
$host = "http://127.0.0.1/cgi-bin";
...
foreach($videos as $video) {
    ...
    $link = $host."/scripts/filme/php/990_desene.php?file=".$link.",".urlencode($title);
    echo '
    <item>
    <title>'.$title.'</title>
    <link>'.$link.'</link>	
