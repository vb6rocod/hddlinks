...
if($search) {
  $url = $url.urlencode($search).",".urlencode($pg_tit);
}
?>
...
//http://moviem.ro/seriale/chuck/sezonul-2-chuck
//http://moviem.ro/seriale/chuck/sezonul-2-chuck/page/2
if ($page==1)
  $link=$search;
else
