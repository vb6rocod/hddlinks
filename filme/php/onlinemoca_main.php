...
echo '
	<item>
	<title>Toate</title>
	<link>http://127.0.0.1/cgi-bin/scripts/filme/php/onlinemoca.php?query=,http://www.onlinemoca.com/</link>
	<annotation>Toate</annotation>

	<mediaDisplay name="threePartsView"/>
	</item>
';
$html = file_get_contents("http://www.onlinemoca.com/filme-online/");
