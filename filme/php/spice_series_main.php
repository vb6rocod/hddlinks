			...
			<text align="left" lines="1" offsetXPC=0 offsetYPC=0 widthPC=100 heightPC=100>
				<script>
					...
					if(focus==idx) 
					{
					  ...
					  desc =  getItemInfo(idx, "annotation");
					}
...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/spice_add.php?mod=add*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 ret="true";
}
...
<channel>
	<title>spicetv.ro - seriale</title>
	<menu>main menu</menu>
<?php
$host = "http://127.0.0.1/cgi-bin";
...
$page = $_GET["query"];
if (!$page) $page=1;
  $link="http://www.ustv.ro/seriale-online/".$page;
  $ch = curl_init();
...
<link>'.$host.'/scripts/filme/php/spice_fav.php</link>
...
foreach($videos as $video) {
   ...
   $link=$host."/scripts/filme/php/spice_series_sez.php?file=".urlencode($link1).",".urlencode($title);
