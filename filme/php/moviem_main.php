...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/moviem_add.php?mod=add*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
//http://moviem.ro/page/1
$link=$search.$page;
if ($page==1) {
echo '
<item>
<title>Lista ta de favorite</title>
<link>'.$host.'/scripts/filme/php/moviem_fav.php</link>
<mediaDisplay name="threePartsView"/>
</item>
';
}
...
foreach($videos as $video) {
  ...
  //$image=str_replace("&","&amp;",$image);
	...
	if ($link <> "") {
		$link = $host."/scripts/filme/php/moviem_sez.php?file=".urlencode($link).",".urlencode($title);
	  echo '
	  <item>
	  <title>'.$title.'</title>
	  <link>'.$link.'</link>
