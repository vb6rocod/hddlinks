...
//http://www.filmeonline.org/category/filme-movies/filme-noi/page/2/
if($page) {
...
//  descriere  
 ...
 $descriere = fix_s($descriere);
	...
	//if($link!="") {
		$link = "http://127.0.0.1/cgi-bin/scripts/filme/php/filmeonline_link.php?file=".$link.",".urlencode($titlu);
		echo'
		<item>
		<title>'.$titlu.'</title>
		<link>'.$link.'</link> 
