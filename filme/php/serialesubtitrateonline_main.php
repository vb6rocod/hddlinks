...
<channel>
	<title>serialesubtitrateonline</title>
	<menu>main menu</menu>
...
if ($tip=="1")
$l="http://serialesubtitrateonline.info/serialecoreene.php";
else
$l="http://serialesubtitrateonline.info/serialeistorice.php";
...
foreach($videos as $video) {
    ...
    $img=$t2[0];
		...
		$link1 = $host."/scripts/filme/php/serialesubtitrateonline.php?query=".urlencode($title).",".urlencode($link);
	echo '
	<item>
	<title>'.$title.'</title>
	<link>'.$link1.'</link>
