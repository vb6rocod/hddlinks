...
<channel>
	<title>serialeonline - seriale</title>
	<menu>main menu</menu>
<item>
<title>Episoade adăugate recent</title>
<link><?php echo $host; ?>/scripts/filme/php/serialeonline_noi.php</link>
</item>
<?php
...
$html = file_get_contents("http://www.serialeonline.tv/");
$videos = explode('cat-item cat-item', $html);
...
foreach($videos as $video) {
    ...
    $t4 = explode("<",$t3[1]);
    $title = $t4[0];
    $link = $host."/scripts/filme/php/serialeonline_sez.php?query=".$t2[0].",".urlencode($title);
    echo '
    <item>
    <title>'.$title.'</title>
    <link>'.$link.'</link>
