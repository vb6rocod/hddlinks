...
//http://documentare.org/seriale#page6
if ($page == 1) {
  $link = $search;
} else {
...
foreach($videos as $video) {
  ...
  $data=str_between($video,'<p class="description">',"</p>");
  ...
  if (strpos($image,'"') !==false) {
	...
	//$link = 'http://127.0.0.1/cgi-bin/scripts/filme/php/documentare_s1.php?query=1,'.$link.",".urlencode($title);
