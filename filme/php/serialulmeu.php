...
$t1=explode('<div id="postcontent"',$html);
$t2=explode('src="',$t1[1]);
$t3=explode('"',$t2[1]);
$image=$t3[0];
$t4=explode("<p>",$t1[1]);
  	...
  	<text redraw="yes" offsetXPC="85" offsetYPC="12" widthPC="10" heightPC="6" fontSize="20" backgroundColor="10:105:150" foregroundColor="60:160:205">
		...
		<text align="justify" redraw="yes" 
          lines="10" fontSize=17
		      offsetXPC=35 offsetYPC=55 widthPC=60 heightPC=45
		      backgroundColor=0:0:0 foregroundColor=200:200:200>
   <?php echo $descriere; ?>
		</text>
		<image  redraw="yes" offsetXPC=51 offsetYPC=22.5 widthPC=25 heightPC=30>
  <?php echo $image; ?>
		</image>
...
$html = str_between($html,'<div id="postcontent"','class="navigation"');
$videos = explode('<a href="', $html);
unset($videos[0]);
$videos = array_values($videos);

foreach($videos as $video) {
$video=str_replace("<strong>","",$video);
$video=str_replace("</strong>","",$video);
//  link  
  $v1 = explode('"', $video);
  $link = $v1[0];
//  titlu
  ...
  if(($titlu <> "") && (strpos($link,"episodul") !==false)) {
