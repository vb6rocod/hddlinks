...
<channel>
	<title>filme-online.ucoz.com</title>
	<menu>main menu</menu>
...
if($page) {
    if($search == 100) {
        $html = file_get_contents("http://www.filme-online.ucoz.com/news/".$page);
    } else {
        $html = file_get_contents("http://www.filme-online.ucoz.com/news/".$page."-0-".$search);
    }
} else {
    $page = 1;
    if($search == 100) {
