...
$desc=str_between($html,'div id="plot">','<br');
...
>
   ...
   <?php echo $desc; ?>
		...
		<image  redraw="yes" offsetXPC=25 offsetYPC=22.5 widthPC=10 heightPC=20>
        <?php echo $img; ?>
		</image>
...
foreach($videos as $video) {
   ...
   $link=$host."/scripts/filme/php/moovie_cc_ep.php?file=".$id.",".urlencode($link).",".urlencode($title);
