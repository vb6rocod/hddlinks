...
//} else {
//$html=str_between($html,'class="slider-item"','');
  $videos = explode('http://www.filmeonlinegratis.ro/filmul',$html);
//}
...
foreach($videos as $video) {
	...
	$t2 = explode('"', $video);
	$link = "http://www.filmeonlinegratis.ro/filmul".$t2[0];
...
//  descriere  
  ...
  $descriere = $v2[0];  
	...
	if ($title && !preg_match("/Comment|Stiri/i",$title)) {
