...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/filmesubtitrate_info_add.php?mod=delete*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
ret;
  ...
  <channel>
    ...
    <title>filmesubtitrate_info - favorite</title>
...
if (file_exists("/data"))
  $f= "/data/filmesubtitrate_info.dat";
else
  $f="/usr/local/etc/filmesubtitrate_info.dat";
if (file_exists($f)) {
