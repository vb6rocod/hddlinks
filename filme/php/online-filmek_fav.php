...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/online-filmek_add.php?mod=delete*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
ret;
  ...
  <channel>
    ...
    <title>online-filmek - favorite</title>
...
if (file_exists("/data"))
  $f= "/data/online-filmek.dat";
else
  $f="/usr/local/etc/online-filmek.dat";
if (file_exists($f)) {
