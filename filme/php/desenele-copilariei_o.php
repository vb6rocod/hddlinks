...
//http://adf.ly/822727/desenele-copilariei.net/http://desenele-copilariei.net/romana/batman-neinfricat-si-cutezator/se-naste-carabusul-albastru
if ($page == 1) {
  $link = $search;
} else {
...
foreach($videos as $video) {
  ...
  $image=$t2[0];
	...
	$link = 'http://127.0.0.1/cgi-bin/scripts/filme/php/desenele-copilariei_link.php?file='.$link;
    echo '
    <item>
    <title>'.$title.'</title>
    <onClick>
