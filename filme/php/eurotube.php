...
//http://eurotube.do.am/publ/0-2
//http://eurotube.do.am/publ/0-1
//http://eurotube.do.am/publ/filme_online_biografice/25-2-2
//http://eurotube.do.am/publ/filme_online_biografice/25-1-2
if ($search == "http://eurotube.do.am/publ/0-")
 $html=file_get_contents($search.$page);
else {
   $ch = curl_init();
   curl_setopt($ch, CURLOPT_URL, $search.$page."-2");
   ...
   curl_close($ch);
   //echo $html;
 //$html=file_get_contents($search.$page."-2");
}
if($page > 1) { ?>
...
$videos = explode('div class="viewn_pict"', $html);
unset($videos[0]);
...
//  titlu
  ...
  $v1=explode('div class="viewn_text"',$video);
  $v3 = explode('>',$v1[1]);
  $v4 = explode('<',$v3[3]);
  $titlu = $v4[0];
