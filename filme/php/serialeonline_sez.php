...
<script>
<?php
//$t1 = explode('<div id="descriere_serial">',$html);
$t1=explode('href="#seasons"',$html);
$t2 = explode('src="',$t1[1]);
$t3 = explode('"',$t2[1]);
$img1=str_replace(" ","%20",$t3[0]);
echo 'channelImage = "'.$img1.'"';
?>
  </script>
...
foreach($videos as $video) {
    ...
    //$t2 = explode('"', $t1[1]);
    //echo $t1[0];
    $link = $host."/scripts/filme/php/serialeonline.php?query=1,".$t1[0].",".urlencode($tit);
    $t3 = explode(">",$video);
    $t4 = explode("<",$t3[1]);
    $title = trim($t4[0]);
    if ($title <> "") {
...
if ($n == 0) {
   $link = $host."/scripts/filme/php/serialeonline.php?query=1,".$cat.",".urlencode($tit);
   $title = "Incomplet";
    echo '
    <item>
    <title>'.$title.'</title>
