...
//http://filmedivix.com/page/2/
//http://filmedivix.com/category/filme-gratis/sf/page/2/
//http://filmedivix.com/category/filme-gratis/sf/
if($page) {
...
foreach($videos as $video) {
  ...
  $t2 = explode('"', $t1[1]);
  $link = $t2[0];
  //http://filmedivix.com/2-days-in-new-york-2012/
  //http://filmedivix.com/filmeonline/2-days-in-new-york-2012-film-online/
  $link="http://filmedivix.com/filmeonline/".substr($link, 0, -1)."-film-online/";
  $link=str_replace("descarca-","",$link);
  /*
  $t3 = explode(">",$t1[2]);
  $t4 = explode("<",$t3[1]);
  $title = $t4[0];
  */
  ...
  if (strpos($video,"default-thumb.png") === false) {
    ...
    $t2 = explode('&', $t1[2]);
    $image = "http://filmedivix.com".$t2[0];
  } else {
...
//  descriere
  ...
  $v1 = explode('<p>', $video);
  $v2 = explode('</p>', $v1[3]);
  $v3=explode("Online Cu Subtitrare",$v2[0]);
