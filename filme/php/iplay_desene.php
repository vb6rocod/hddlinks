...
showIdle();
movie_info="http://127.0.0.1/cgi-bin/scripts/filme/php/iplay_desene_det.php?file=" + movie + "," + <?php echo $page; ?> + "," + <?php echo $tip; ?>;
...
ret;
	...
	<gotopage>
	  <link>
	    <script>
        "<?php echo $host; ?>/scripts/filme/php/iplay_desene.php?query=" + urlEncode(keyword) + "," + "<?php echo $tip; ?>";
        </script>
	  </link>
	</gotopage>
<?php
...
if ($tip=="0") //recente
  $link="http://videobox.iplay.ro/movies/cartoons/page/".$page;
...
$totpages=$t2[0];
echo '
	<title>iPlay - desene - pagina '.$page.'/',$totpages.'</title>
	<menu>main menu</menu>
';
if($page > 1) { ?>
