...
$html = file_get_contents("http://www.serialulmeu.ro/");
...
foreach($videos as $video) {
    ...
    $t2 = explode('"',$t1[1]);
    $title = $t2[0];
    $title = trim(str_replace("Online","",$title));
    $link = $host."/scripts/filme/php/serialulmeu.php?query=".$link.",".urlencode($title);
    echo '
    <item>
    <title>'.$title.'</title>
