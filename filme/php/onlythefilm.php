...
//http://www.onlythefilm.com/category/filme/
//http://www.onlythefilm.com/category/filme/page/2/
if($page) {
...
//  descriere
  $descriere=str_between($video,'Online Subtitrat Gratis','<');
  ...
  if($link!="") {
    $link  = $host."/scripts/filme/php/filme_link.php?".$link.",".urlencode($titlu);
    echo'
    <item>
    <title>'.$titlu.'</title>
    <link>'.$link.'</link>
