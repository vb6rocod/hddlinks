...
<channel>
	<title>Filme româneşti - categorii</title>
	<menu>main menu</menu>
...
$host = "http://127.0.0.1/cgi-bin";
$html = file_get_contents("http://filmele-copilariei.blogspot.com/");
...
foreach($videos as $video) {
	...
	$link = $host."/scripts/filme/php/filmele-copilariei.php?query=,".$link;
  echo '
  <item>
  <title>'.$title.'</title>
  <link>'.$link.'</link>
