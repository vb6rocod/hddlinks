...
$post="type=get_movies&query=type:1|sort:new|view:covers|page:".$page."|genres:|year_min:1919|year_max:2020|allcast:0|rating_min:0|rating_max:10|genres_and:0|";
     $ch = curl_init();
...
foreach($videos as $video) {
    ...
    $adn=$title1." (".$year.")";
		...
		$link = $host.'/scripts/filme/php/moovie_cc_link.php?file='.$link.','.urlencode($title);
