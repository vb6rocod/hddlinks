...
$host = "http://127.0.0.1/cgi-bin";
  $link="http://www.movie-inn.com/main.php?page=series";
  $ch = curl_init();
...
$videos = explode('series.php?id=', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $link=$host."/scripts/filme/php/movie-inn_ep.php?query=".$link.",".urlencode($title);
  echo '
  <item>
  <title>'.$title.'</title>
  <link>'.$link.'</link>
