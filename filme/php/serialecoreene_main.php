...
$html = file_get_contents("http://www.serialecoreene.com/");
$html=str_between($html,'Seriale Coreene:','</ul>');
...
foreach($videos as $video) {
    ...
    $data=$title;
    if ($link <> "") {
		$link = $host.'/scripts/filme/php/serialecoreene.php?file='.$link.",".urlencode($title);
