...
<channel>
	<title>filmeonline24.com - categorii</title>
	<menu>main menu</menu>
...
$host = "http://127.0.0.1/cgi-bin";
$html = file_get_contents("http://www.filmeonline24.com/");

$img = "image/movies.png";
	$link = $host."/scripts/filme/php/filmeonline24.php?query=,http://www.filmeonline24.com/";
  echo '
  <item>
...
foreach($videos as $video) {
	...
	$link = $host."/scripts/filme/php/filmeonline24.php?query=,".$link;
  echo '
  <item>
  <title>'.$title.'</title>
  <link>'.$link.'</link>
