...
>
    ...
    Apăsaţi 1 sau 2 pentru salt +- 100
  	...
  	<text redraw="no" offsetXPC="85" offsetYPC="12" widthPC="10" heightPC="6" fontSize="20" backgroundColor="10:105:150" foregroundColor="60:160:205">
		...
		<image  redraw="yes" offsetXPC=60 offsetYPC=22.5 widthPC=25 heightPC=25>
...
$html=str_between($html,'class="list-episodes"','</ul');
...
foreach($videos as $video) {
    ...
    if ($link <> "") {
       ...
       $link=$host."/scripts/filme/php/vezi-online_link.php?file=".urlencode($link).','.urlencode($title);
  echo '
  <item>
  <title>'.$title.'</title>
  <link>'.$link.'</link>
