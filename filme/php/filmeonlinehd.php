...
<channel>
	<title>www.filmeonlinehd.in</title>
	<menu>main menu</menu>
...
if ($page==1) {
  $html = file_get_contents("http://www.filmeonlinehd.in");
} else {
  $html = file_get_contents("http://www.filmeonlinehd.in/page/".$page."/");
}
if($page > 1) { ?>
...
//$html=str_between($html,'<div class="slides">','</ul>');
$videos = explode('<h2 class="post-title">', $html);
