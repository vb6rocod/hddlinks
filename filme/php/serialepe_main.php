...
//username@pass
$filename = "/usr/local/etc/dvdplayer/serialepe.txt";
...
$post="log=".$user."&pwd=".$pass."&rememberme=forever&wp-submit=Log+In&redirect_to=http%3A%2F%2Fwww.serialepe.net%2Fwp-admin%2F&testcookie=1";
 ...
 $l="http://www.serialepe.net/wp-login.php";
  $ch = curl_init();
...
$description="Pentru a accesa acest site trebuie să aveţi un cont pe serialepe.net (este gratis). Completaţi userul şi parola în acest formular şi apoi apăsaţi Return, Return după care accesaţi din nou această pagină. Dacă userul şi parola sunt corecte veţi putea vedea lista serialelor.";
