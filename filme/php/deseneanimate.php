...
//http://deseneanimate.tv/view.php?serial=Chuggington&episode=2
for ($i = 1; $i <= 10; $i++) {
    $episod = ($page-1)*10 + $i;
    $title = $tit." Episodul ".$episod;
    $link = $search."&episode=".$episod;
    //$link = str_replace(" ","%20",$link);
    $link = "http://127.0.0.1/cgi-bin/scripts/filme/php/filme_link.php?".urlencode($link).",".urlencode($title);
    echo '
    <item>
    <title>'.$title.'</title>
    <link>'.$link.'</link>	
