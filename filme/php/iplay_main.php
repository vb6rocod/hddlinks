...
if($query) {
   ...
   $page = urldecode($queryArr[0]);
   $tip = urldecode($queryArr[1]);
}
?>
<rss version="2.0">
<onEnter>
...
if ($tip=="0") //recente
  $link="http://videobox.iplay.ro/series/index/sort/created/dir/desc/page/".$page;
else if ($tip=="1") // top rating
  $link="http://videobox.iplay.ro/series/index/sort/rating/dir/desc/page/".$page;
else if ($tip=="2") //alfabetic
  $link="http://videobox.iplay.ro/series/index/sort/title/dir/asc/page/".$page;
  //$link="http://videobox.iplay.ro/series/index/page/".$page;
  $ch = curl_init();
...
<?php } ?>
<?php
$videos = explode('<div class="seriesCell ">', $html);
$c=count($videos);
$n=0;
unset($videos[0]);
...
foreach($videos as $video) {
 ...
 $t1=explode('seriesCellTitle"',$video);
 $t2=explode('>',$t1[1]);
 $t3=explode('<',$t2[1]);
 $title1=$t3[0];
