...
//http://vplus.ro/movies?s=st
$link="http://vplus.ro/movies?s=".$search;
...
$html1 = str_between($html,'class="movies_list"',"</ul>");
...
foreach($videos as $video) {
  ...
  //$description = str_between($video,'<span class="s_e">','</span>');
    ...
    <script>
    showIdle();
    url="http://127.0.0.1/cgi-bin/scripts/filme/php/vplus_link.php?file='.$link.'";
    movie=getURL(url);
    cancelIdle();
